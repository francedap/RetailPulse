...
if not df_magazzino.empty:
    ...
    categorie_utente = ["Sneakers", "Elettronica", "Abbigliamento", "Accessori"] 
...
with col_btn_cat:
    btn_trend = st.button("Analizza Categoria", width='stretch')
...
if st.button("Report Strategico Mercato", width='stretch'):
